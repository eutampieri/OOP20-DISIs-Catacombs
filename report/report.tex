...
\begin{document}
    ...
    \subsection{Chelli}
    \par Questa parte si concentrera' sugli aspetti relativi alla mappa di gioco.
    ...
    \begin{tikzpicture}
        ...
        \end{interface}
        \begin{class}[text width=3.5cm]{TileMapImpl}{4, 0}
            \implement{TileMap}
    ...
    \begin{tikzpicture}
        ...
        \end{interface}
        \begin{class}[text width=3.5cm]{TileMapFactoryImpl}{4, 0}
            \implement{TileMapFactory}
        \end{class}
    \end{tikzpicture}
    \par Per la creazione delle TileMap ho deciso di usare una Factory,
    anche questa l'ho divisa in interfaccia e implementazione,
    ...
    \par L'implementazione della Factory, fa uso di una classe privata ed e' divisa in diverse funzioni private
    ...
    tranne quella vuota usata per il testing.
