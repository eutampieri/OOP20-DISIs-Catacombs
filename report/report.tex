...
\begin{document}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {abstractclass}[text width=3.5cm]{Entity}{0, -10}
                \attribute {\#face: Direction}
                \attribute {\#hp: int}
                \operation {\#kind: GameObjectType}
                \attribute {\#width: int}
            ...
            \begin {class}[text width=3.5cm]{Bat}{-7, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
            ...
            \begin {class}[text width=3.5cm]{Slime}{+7, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {abstractclass}[text width=3.5cm]{Weapon}{0, -10}
                \attribute {\#strength: int}
                \attribute {\#ps: int}
                \operation {\#fireRate: long}
                \attribute {\#canFire: boolean}
            ...
            \begin {class}[text width=3.5cm]{Gun}{-5, 0}
                \inherit {Weapon}
            ...
            \begin {class}[text width=3.5cm]{Rifle}{+5, 0}
                \inherit {Weapon}
                \operation {+getStrength(): int}
                \operation {+getFireRate(): int}
                \operation {+getProjectileSpeed(): int}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {class}[text width=3.5cm]{ObjectFactoryImpl}{0, -5}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {interface}[text width=3.5cm]{MobFactory}{0, 0}
            ...
            \begin {class}[text width=3.5cm]{MobFactoryImpl}{0, -5}
