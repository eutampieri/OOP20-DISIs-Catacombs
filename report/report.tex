...
\begin{document}
    ...
    \begin{tikzpicture}
        \tikzstyle{every node}=[font=\scriptsize]
            \begin {abstractclass}[text width=10cm]{GameObject}{-10, -8}
                \attribute {\#posX: int}
                \attribute {\#posY: int}
            ...
            \begin {abstractclass}[text width=5cm]{Entity}{-10, -2}
                \inherit {GameObject}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {class}[text width=6cm]{Bat}{-13, 0}
                \inherit {Entity}
                \operation {+setShootingDirection(e: GameObject): void}
                \operation {-changeDirection: void}
            \end {class}

            \begin {class}[text width=6cm]{Boss}{0, -5}
                \inherit {Entity}
                \operation {+setShootingDirection(e: GameObject): void}
                \operation {-changeDirection: void}
            \end {class}

            \begin {class}[text width=6cm]{Slime}{+4, 0}
                \inherit {Entity}
