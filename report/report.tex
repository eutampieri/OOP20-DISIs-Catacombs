...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item Uso di lambda expression in \texttt{AssetManagerProxy} e \texttt{ImageTransformFactoryImpl}
    ...
    \begin{itemize}
        \item How to scale a \texttt{BufferedImage}\cite{so:BufferedImageScaling}, \texttt{src/main/java/eu/eutampieri/catacombs/ui/utils/ImageTransformFactoryImpl.java}, linee 23-29.
    \end{itemize}
