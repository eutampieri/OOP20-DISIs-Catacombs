...
\begin{document}
    ...
    \begin{tikzpicture}
        \tikzstyle{every node}=[font=\scriptsize]
            \begin {abstractclass}[text width=7.5cm]{GameObject}{0, -5}
                \attribute {\#posX: int}
                \attribute {\#posY: int}
            ...
            \begin {abstractclass}[text width=7.5cm]{Entity}{-7.5, 0}
                \inherit {GameObject}
            ...
            \begin {abstractclass}[text width=7.5cm]{Weapon}{+7.5, 0}
                \inherit {GameObject}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {abstractclass}[text width=8.5cm]{Entity}{-10, -10}
                \attribute {\#face: Direction}
                \attribute {\#hp: int}
                \operation {\#kind: GameObjectType}
                \attribute {\#width: int}
            ...
            \begin {class}[text width=8.5cm]{Bat}{-13, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
            ...
            \begin {class}[text width=8.5cm]{Boss}{-3, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
                \operation {+setShootingDirection(e: GameObject): void}
                \operation {-changeDirection: void}
            ...
            \begin {class}[text width=8.5cm]{Slime}{+4, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
