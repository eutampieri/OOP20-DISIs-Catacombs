...
\begin{document}
    ...
    %UML
    \begin{tikzpicture}
        \begin{abstractclass}[text width=5cm] {State}{0, 0}

            \operation{+ update(delta : long)}
            \operation[0]{+ render(g2 : Graphics2D)}
        \end{abstractclass}

        \begin{class}[text width=7cm]{MenuState}{ -10, -10}
            \inherit{State}
        ...
        \begin{class}[text width=7cm]{GameState}{0 , -10}
            \inherit{State}
        ...
        \begin{class}[text width=7cm]{EndGameState}{10 , 10}
            \inherit{State}
