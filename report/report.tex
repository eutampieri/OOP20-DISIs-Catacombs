...
\begin{document}
    ...
    \begin{tikzpicture}
        \tikzstyle{every node}=[font=\scriptsize]
            ...
            \begin {abstractclass}[text width=10cm]{Entity}{-5, 0}
                \inherit {GameObject}
            ...
            \begin {abstractclass}[text width=10cm]{Weapon}{5, 0}
                \inherit {GameObject}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {abstractclass}[text width=8cm]{Entity}{0, -10}
                \attribute {\#face: Direction}
                \attribute {\#hp: int}
                \operation {\#kind: GameObjectType}
                \attribute {\#width: int}
            ...
            \begin {class}[text width=8cm]{Bat}{-7, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
            ...
            \begin {class}[text width=8cm]{Boss}{0, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
                \operation {+setShootingDirection(e: GameObject): void}
                \operation {-changeDirection: void}
            ...
            \begin {class}[text width=8cm]{Slime}{+7, 0}
                \inherit {Entity}
                \operation {+update(delta: long, others: List<GameObject>): List<GameObject>}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {abstractclass}[text width=9cm]{Weapon}{0, -10}
                \attribute {\#strength: int}
                \attribute {\#ps: int}
                \operation {\#fireRate: long}
                \attribute {\#canFire: boolean}
            ...
            \begin {class}[text width=9cm]{Gun}{-5, 0}
                \inherit {Weapon}
            ...
            \begin {class}[text width=9cm]{Rifle}{+5, 0}
                \inherit {Weapon}
                \operation {+getStrength(): int}
                \operation {+getFireRate(): int}
                \operation {+getProjectileSpeed(): int}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {interface}[text width=7cm]{ObjectFactory}{0, 0}
            ...
            \begin {class}[text width=7cm]{ObjectFactoryImpl}{0, -5}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin {interface}[text width=5cm]{MobFactory}{0, 0}
            ...
            \begin {class}[text width=5cm]{MobFactoryImpl}{0, -5}
