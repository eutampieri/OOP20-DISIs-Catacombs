...
\begin{document}
    ...
    \par Il gioco comincerà con una schermata di menu che permette di cambiare l'opzione che si desidera scegliere attraverso l'uso
     ...
     \par Una volta iniziata la partita il personaggio si potrà spostare la mappa utilizzando i tasti direzionali, ovvero le
    ...
    \par Il giocatore potrà sparare ai nemici per eliminarli usando il tasto spazio, sia tenendolo premuto che premendolo ripetutamente,
     e per poter mirare al nemico bastera rivolgere il corpo del giocatore nella direzione desiderata (e.g se un nemico si trova alla
