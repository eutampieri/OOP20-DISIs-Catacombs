...
\begin{document}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin{interface}[text width=3.5cm]{LogicMenu}{-5, -5}
            ...
            \begin{class}[text width=3.5cm]{LogicMenuImpl}{-5, -10}
                \implement{LogicMenu}
            ...
            \begin{class}[text width=3.5cm]{EndGameState}{5, 0}

                \operation{+ update(delta : long)}
                \operation{+ render(g2 : Graphics2D)}
            \end{class}

            \begin{interface}[text width=3.5cm]{EndGameLogic}{5, -5}
            ...
            \begin{class}[text width=3.5cm]{EndGameLogicImpl}{5, -10}
