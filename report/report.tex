...
\begin{document}
    ...
    \par
        \begin{tikzpicture}
            ...
            \begin{abstractclass}[text width=3.5cm]{State}{0, 2}

                \operation{+ update(delta : long)}
                \operation{+ render(g2 : Graphics2D)}
            \end{abstractclass}

            \begin{class}[text width=3.5cm]{MenuState}{-5, -7}
                \inherit{State}
            ...
            \begin{class}[text width=3.5cm]{GameState}{0, -7}
                \inherit{State}
            ...
            \begin{class}[text width=3.5cm]{EndGameState}{5, -7}
                \inherit{State}
    ...
    \par
        \begin{tikzpicture}
            \tikzstyle{every node}=[font=\scriptsize]
            \begin{class}[text width=3.5cm]{MenuState}{-5, 2}

                \operation{+ update(delta : long)}
                \operation{+ render(g2 : Graphics2D)}
            \end{class}

            \begin{interface}[text width=3.5cm]{LogicMenu}{5, 2}
            ...
            \begin{class}[text width=3.5cm]{LogicMenuImpl}{5, -7}
                \implement{LogicMenu}
