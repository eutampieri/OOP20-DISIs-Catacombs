...
\begin{document}
    ...
    \par
    \begin{tikzpicture}
        \begin{abstractclass}[text width=2cm] {State}{0, 0}

            \operation{+ update(delta : long)}
            \operation[0]{+ render(g2 : Graphics2D)}
        \end{abstractclass}

        \begin{class}[text width=2cm]{MenuState}{-5, -5}
            \inherit{State}
        ...
        \begin{class}[text width=2cm]{GameState}{0, -5}
            \inherit{State}
        ...
        \begin{class}[text width=2cm]{EndGameState}{5, -5}
            \inherit{State}
