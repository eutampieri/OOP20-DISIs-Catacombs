...
\begin{document}
    ...
    \par
            \begin{tikzpicture}
                ...
                \begin{abstractclass}[text width=3.5cm]{State}{-2.5, 0}

                    \operation{+ update(delta : long)}
                    \operation{+ render(g2 : Graphics2D)}
                \end{abstractclass}

                \begin{interface}[text width=3.5cm]{TransitionFactory}{2.5, 0}

                    \operation{transState(message : String, game : DungeonGame, state : State)}
                \end{interface}


                \begin{class}[text width=3.5cm]{TransitionFactoryImpl}{2.5, -5}
                ...
                \association{TransictionFactory}{creates }{}{State}{}{}
            \end{tikzpicture}
